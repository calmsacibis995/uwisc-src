 ...
 */
#ifndef lint
static char rcs_id[] = {"$Header: udp_usrreq.c,v 3.1 86/10/22 13:36:34 tadl Exp $"};
#endif not lint
/*
 * RCS Info
 *	$Locker:  $
...
#ifdef NFS
int	udp_sendspace = 9000;	/* so nfs can do large atomic writes */
int	udp_recvspace = 2 * (9000+sizeof(struct sockaddr_in)); /* 2 9000b dgrams */
#else
