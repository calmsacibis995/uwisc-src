 ...
 */
#ifndef lint
static char rcs_id[] = {"$Header: syscalls.c,v 3.1 86/10/22 13:43:33 tadl Exp $"};
#endif not lint
/*
 * RCS Info
 *	$Locker:  $
...
char *syscallnames[] = {
	...
	"lseek",		/*  19 = lseek */
	"getpid",		/*  20 = getpid */
	"old mount - nosys",		/*  21 = mount */
	"old umount - nosys",		/*  22 = umount */
	...
	"#161",			/* 161 = nosys */
#endif
	"#162",			/* 162 = getdomainname */
	"#163",			/* 163 = setdomainname */
#ifdef PCFS
