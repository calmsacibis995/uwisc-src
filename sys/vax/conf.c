 ...
 */
#ifndef lint
static char rcs_id[] = {"$Header: conf.c,v 3.1 86/10/22 13:51:13 tadl Exp $"};
#endif not lint
/*
 * RCS Info
 *	$Locker:  $
...
/*
 * MicroVAX virtual console support
 */
/*
 * Virtual console character display routine.
 * The drivers will fill this in as they configure.
 */
int (*v_console)() = 0;
...
/* 42-50 reserved to local sites */
 	...
 	qdselect,	nodev,
 	qvopen,		qvclose,	qvread,		qvwrite,	/*43*/
 	qvioctl,	qvstop,		qvreset,	qv_tty,
 	qvselect,	nodev,
	cnopen,		cnclose,	cnread,		cnwrite,	/*44*/
	cnioctl,	nulldev,	nulldev,	&cons,
	ttselect,	nodev,
};
