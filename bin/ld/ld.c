...
#define	NDIRS	25
#ifdef UW
#define NDEFDIRS 6		/* number of default directories in dirs[] */
#else
...
char **argv;
{
	...
	dirs[ndir++] = "/usr/lib";
#ifdef UW
	dirs[ndir++] = "/usr/uw/lib";
	dirs[ndir++] = "/usr/misc/lib";
	/* i am leaving /usr/local/lib here just in case  */
#endif UW
	dirs[ndir++] = "/usr/local/lib";
#ifdef UW
	dirs[ndir++] = "/usr/crystal/lib";
#endif UW
