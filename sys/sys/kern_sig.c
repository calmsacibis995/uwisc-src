 ...
 */
#ifndef lint
static char rcs_id[] = {"$Header: kern_sig.c,v 3.1 86/10/22 13:41:49 tadl Exp $"};
#endif not lint
/*
 * RCS Info
 *	$Locker:  $
...
core()
{
	...
	if (u.u_procp->p_textp) {
		u.u_error = VOP_ACCESS(u.u_procp->p_textp->x_vptr, VREAD, u.u_cred);
		if (u.u_error) 
			return (0);
	}
	u.u_error = 0;
