 ...
 * User telnet program.
 *
 *	Mods by Dave Cohrs to not print option information if not connected
 *	to a telnet port. Installed 5 April 1986 by David Parter
 *
 *	Modified Aug 12 10:51 1986 by Dave Cohrs
 *	added ability to specify the port with alpnanumerics and fixed a bug
 *	in recognizing invalid port numbers (signed compare of unsigned value).
 */
...
#ifdef UW
	if (argc > 1 && !strcmp(argv[1], "-s")) { /* a new show options option */
		showoptions = 1;
		argv++;
		argc--;
	}
