 ...
 */
#ifndef lint
static char rcs_id[] = {"$Header: autoconf.c,v 3.1 86/10/22 13:50:47 tadl Exp $"};
#endif not lint
/*
 * RCS Info
 *	$Locker:  $
...
#define QMEM		((char *)(0x30000000))
#define QDEVADDR	((u_short *)(0x20000000))
		ioaccess(QMEM, memmap, QMEMSIZE);
		ioaccess(QDEVADDR, memmap+btop(QMEMSIZE), 16*NBPG);
#else
...
#ifdef MVAX
#define	ubaddr(off)	(u_short *)((int)vumem + (512*8192) + ubaoff(off))
#else
...
#ifdef MVAX
				ui->ui_physaddr = (caddr_t)(QDEVADDR + ubaoff(addr));
#else
