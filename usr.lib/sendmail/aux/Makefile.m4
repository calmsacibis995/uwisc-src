...
uuroute: uuroute.c
	cc -I$(SRCDIR) $(CFLAGS) -o $@ $*.c $(SRCDIR)/stab.o $(SRCDIR)/clock.o $(SRCDIR)/util.o $(LIBS)
...
install: all
	strip uuroute
	mv -f uuroute $(DESTDIR)/usr/uw/lib/uubang
	chmod 755 $(DESTDIR)/usr/uw/lib/uubang
