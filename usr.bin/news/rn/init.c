/* $Header: init.c,v 2.2 86/09/06 10:16:19 dave Exp $
/* $Header: init.c,v 4.3.1.4 86/09/05 14:24:02 lwall Exp $
 * $Log:	init.c,v $
 * Revision 2.2  86/09/06  10:16:19  dave
 * mod.announce is the group to check for -- not net.announce
 * 
 * Revision 2.1  86/09/06  10:03:50  dave
 * Initial UW revision
 * 
