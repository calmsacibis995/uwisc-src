 ...
 *
 * $Header: compress.c,v 1.1 86/08/26 21:32:56 root Exp $
 * $Log:	compress.c,v $
 * Revision 1.1  86/08/26  21:32:56  root
 ...
 *
 */
static char rcs_ident[] = "$Header: compress.c,v 1.1 86/08/26 21:32:56 root Exp $";
