 ...
 */
#ifndef lint
static char rcs_id[] = {"$Header: machdep.c,v 3.1 86/10/22 13:52:57 tadl Exp $"};
#endif not lint
/*
 * RCS Info
 *	$Locker:  $
	...
	int firstaddr;
{
	 ...
	 * succeds in setting up the screen.  Precidence is determined by
...
#ifdef UW
	mminit();	/* do extra mm device initialization */
#endif UW
	/*
